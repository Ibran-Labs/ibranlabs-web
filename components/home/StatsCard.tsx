...
export const StatsCard: React.FC<StatsCardProps> = ({ pool }) => {
  ...
  if (!isConnected) {
    return (
      <Card className="w-full max-w-2xl flex justify-center items-center bg-gray-900 text-gray-100 shadow-xl border border-cyan-800">
        <CardContent className="w-full max-w-2xl flex flex-col mx-auto px-6 py-8 justify-center items-center">
  ...
  if (!pool) {
    return (
  <Card className="w-full max-w-2xl bg-gray-900 text-gray-100 shadow-xl border border-cyan-800">
